                ...
                <nav class="flex gap-x-1" aria-label="Tabs" role="tablist" aria-orientation="horizontal">
                    ...
                    <button type="button"
                        class="px-5 hs-tab-active:font-semibold  hs-tab-active:text-blue-600 
                               hs-tab-active:bg-slate-100 py-4 px-1 inline-flex flex-col items-center gap-y-2 border-b-2 
                        ...
                        role="tab">
                        <div class="bg-white border-2 h-10 w-10 rounded-full">
                    ...
                    @foreach ($colorCategories as $index => $colorCategory)
                        <button type="button"
                            ...
                            <div class="bg-{{ $colorCategory->color_code }} 
                              ">
                                <img class="border-2 h-10 w-10 rounded-full" src="{{ $colorCategory->color_code_image }}"
                                    alt="">
                            </div>
